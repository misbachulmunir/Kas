...
Public Class laporan_saldonyaya
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KAS.laporan_saldonyaya.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_saldonyaya
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_saldonyaya = New laporan_saldonyaya()
        rpt.Site = Me.Site
        Return rpt
    End Function
