...
Public Class pemasukanlainrepot
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "KAS.pemasukanlainrepot.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedpemasukanlainrepot
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As pemasukanlainrepot = New pemasukanlainrepot()
        rpt.Site = Me.Site
        Return rpt
    End Function
